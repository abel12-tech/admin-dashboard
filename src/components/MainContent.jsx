...
import {
  useGetAllDataQuery,
  useGetDataInWarehouseQuery,
} from "../features/dashboard-summary/dataApi";
import {
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  {isSuccess
                    ? datas.dashboardSummary.totalFarmers
                    : "Loading..."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {isSuccess
                    ? datas.dashboardSummary.totalOrders
                    : "Loading..."}
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  {warehouseDataSuccess
                    ? warehouseData?.dashboardSummary.totalFarmers
                    : "Loading..."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {warehouseDataSuccess
                    ? warehouseData?.dashboardSummary.totalProducts
                    : "Loading..."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {isSuccess
                    ? warehouseData?.dashboardSummary.totalOrders
                    : "Loading..."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {warehouseDataSuccess
                    ? warehouseData?.dashboardSummary.totalUsers
                    : "Loading..."}
                </p>
              </div>
            </div>
