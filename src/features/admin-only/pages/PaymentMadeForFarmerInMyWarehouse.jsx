...
import {
  ...
  useGetPaymentMadeForFarmerInMyWarehouseQuery,
} from "../../manage-farmers/api/farmerApi";

const PaymentMadeForFarmerInMyWarehouse = () => {
  ...
  const totalPages =
    Math.ceil(payments?.farmerPaymentsInWarehouse.length / itemsPerPage) || 1;

  const startIndex = (currentPage - 1) * itemsPerPage;
  const endIndex = Math.min(
    startIndex + itemsPerPage,
    payments?.farmerPaymentsInWarehouse.length
  );
            ...
            <table className="w-full whitespace-no-wrap">
              ...
              >
                {isLoading ? (
                  ...
                  payments?.farmerPaymentsInWarehouse
...
export default PaymentMadeForFarmerInMyWarehouse;
