...
} from "../../manage-products/api/productsApi";

const ProductsInMyWarehouse = () => {
  ...
  const totalPages =
    Math.ceil(products?.productsInWarehouse.length / itemsPerPage) || 1;
  ...
  const endIndex = Math.min(
    ...
    products?.productsInWarehouse.length
  );
...
export default ProductsInMyWarehouse;
