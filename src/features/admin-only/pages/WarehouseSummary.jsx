...
import { useGetDataInWarehouseQuery } from "../../dashboard-summary/dataApi";
import {
  selectAdminwarehouseInfo,
  selectIsSuper,
} from "../../authentication/slice/authSlice";
...
const WarehouseSummary = () => {
  ...
  const { data: datas, isSuccess } = useGetDataInWarehouseQuery();
